...
class AppLocalizations {
  ...
  String get closeSidebar =>
      _isFr ? 'Fermer la barre latérale' : 'Close sidebar';
  ...
  String get switchToLight =>
      _isFr ? 'Passer au thème clair' : 'Switch to light mode';
  String get switchToDark =>
      _isFr ? 'Passer au thème sombre' : 'Switch to dark mode';
  ...
  String get settingsContextHint =>
      _isFr
  ...
  String get dislikeDialogTitle =>
      _isFr
          ? 'Pourquoi cette réponse ne vous a-t-elle pas plu ?'
  ...
  String get useImprovedPrompt =>
      _isFr ? 'Utiliser le prompt amélioré' : 'Use improved prompt';
  String get copied =>
  ...
  String daysAgoShort(int days) => _isFr ? 'Il y a $days j' : '${days}d ago';
  ...
  // Prompt details
  String get promptReview => _isFr ? 'Analyse du prompt' : 'Prompt review';
  ...
  String get errorEvaluatingPrompt =>
      _isFr
          ? 'Erreur lors de l’évaluation de la requête'
          : 'Error while evaluating prompt';
  ...
  String get checkApiKeyAndRetry =>
      _isFr
